...
| 3 | Links active, configuration normalized | Tested communication using `ping` via Windows Command Prompt | Communication successful — all updated device configurations saved using `write` | <img src="Elements/Step3.png"> |
