...
| 3 | Links active, configuration normalized | Tested communication using `ping` via Windows Command Prompt | Communication successful — configuration saved using `write` on all updated devices | <img src="Elements/Step3.png"> |
