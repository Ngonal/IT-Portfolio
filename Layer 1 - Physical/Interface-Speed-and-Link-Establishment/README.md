...
| 3 | Links active, configuration normalized | Tested communication using `ping` via Windows Command Prompt | Communication successful - saved configuration with `write` | <img src="Elements/Step3.png"> |
