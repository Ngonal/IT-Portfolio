...
| 3 | Both hosts are now able to communicate | Tested communication `ping` via Windows Command Prompt - saved configuration with `write` | Communication successful | <img src="Elements/Step3.png"> |
