...
- **Down / Down** — possible causes include an absent or damaged cable, improperly seated connectors, incorrect cable type or pinout, or a local/remote device that is powered off, misconfigured, or faulty
